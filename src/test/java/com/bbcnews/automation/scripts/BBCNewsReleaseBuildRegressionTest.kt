...
//            for (i in 0 until myNewsPageObject.articlepageelements_Release.size) {
//                commonFunctionKotlin.isElementPresent(androidDriver, By.id(myNewsPageObject.articlepageelements_Release[i]))
//            }
