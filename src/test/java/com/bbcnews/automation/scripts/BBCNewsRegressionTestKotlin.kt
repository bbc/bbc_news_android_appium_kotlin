...
//    private val DateToStr = format.format(curDate)
   ...
   private  fun setUP() {
    ...
    fun openBBCNewsApp() {
        try {
            commonFunctionKotlin.startTest("HomePage", "Checking the HomePage", "HomePage")
    ...
    fun testVideoofthedayDisplayed() {
        commonFunctionKotlin.startTest("HomePage", "Checking the VideoOfTheDay", "HomePage")
    ...
    fun testToCheckTopicsTopStores() {
        try {
            commonFunctionKotlin.startTest("HomePage", "Scroll to a Topics on Home Page", "HomePage")
            commonFunctionKotlin.scrolltoElement(androidDriver, homePageObject.Business_topics)
            commonFunctionKotlin.tapButton(androidDriver, homePageObject.Business_topics, false)
            ...
            commonFunctionKotlin.tapButton(androidDriver, homePageObject.top_stories_Politics, false)
            commonFunctionKotlin.tapButton(androidDriver, myNewsPageObject.mynews_addtopics, false)
    ...
    fun testMyNews_TopStoriesTopics() {
        try {
            commonFunctionKotlin.startTest("MyNews", "Test to check Topics on MyNews page", "MyNews")
            ...
            try {
                commonFunctionKotlin.elementDisplayed(androidDriver, homePageObject.UKPolitics_topheading)
                commonFunctionKotlin.elementDisplayed(androidDriver, homePageObject.Business_topics)
            } catch (e: Exception) {
                e.printStackTrace()
            }
    ...
    fun testMyNews() {
        try {
            commonFunctionKotlin.startTest("MyNews", "Test to check MyNews page", "MyNews")
            commonFunctionKotlin.tapButton(androidDriver, basePageObject.mynews, false)
    ...
    fun testAddingTopicsPage() {
        try {
            commonFunctionKotlin.startTest("MyNews", "Test to check Edit MyNews page", "MyNews")
            commonFunctionKotlin.tapButton(androidDriver, myNewsPageObject.mynews_startButton, false)
    ...
    fun testAddingTopicstoMyNewsPage() {
        try {
            commonFunctionKotlin.startTest("MyNews", "Test to check added Topics MyNews page", "MyNews")
    ...
    fun testSelectedAddedTopics(){
            commonFunctionKotlin.startTest("MyNews", "Selecting Added Topics", "MyNews")
    ...
    @Test(priority = 12, description = "Test to check the Popular page and also to check Most Read Displayed")
    @Throws(Exception::class)
    fun testPopularPage() {
    ...
    @Test(priority = 13, description = "Test to select one Article from Most Read  Article from Popular Page")
    @Throws(Exception::class)
...
//            }
    ...
    @Test(priority = 14, description = "Test to check whether the Most Watched heading displayed in Popular Page")
    ...
    fun testSearchStories() = try {
        ...
        assertEquals(searchTopicstext, "Topics (3)", "matched")
        commonFunctionKotlin.sleepmethod(1000)
    ...
    @Test(priority = 21, description = "Test Checking an Article page without an Item Image Badge")
    @Throws(Exception::class)
    fun testartictleitemwithoutitembadge() {
        try {
            commonFunctionKotlin.startTest("ArticlePage", "Checking an Article page without an Item Image Badge", "Article")
            commonFunctionKotlin.tapButton(androidDriver, basePageObject.searchbutton, false)
            basePageObject.searchfield.clear()
            commonFunctionKotlin.enterText( basePageObject.searchfield, "India")
            commonFunctionKotlin.sleepmethod(1000)
    ...
    @Test(priority = 22, description = "Test Checking an Article page with an Item Image Badge")
    @Throws(Exception::class)
    ...
    @Test(priority = 23, description = "Test to search for an particular article")
    @Throws(Exception::class)
    ...
    @Test(priority = 24, description = "Test to search for an particular video article")
    @Throws(Exception::class)
    fun testondemandvideoplyback() {
        try {
            commonFunctionKotlin.startTest("ArticlePage", "Test to search ana play a on-demand video", "Article")
            commonFunctionKotlin.tapButton(androidDriver, basePageObject.searchbutton, false)
            basePageObject.searchfield.clear()
            commonFunctionKotlin.enterText(basePageObject.searchfield, "video")
            commonFunctionKotlin.sleepmethod(2000)
            ...
            while (i < vidoePageObject.videodetailpage.size && i < vidoePageObject.videdetailpagetext.size)
            {
                ...
                assertEquals(vidoePageObject.videdetailpagetext[i], androidDriver.findElement(By.id(vidoePageObject.videodetailpage[i])).text, "Test matched")
                i++
            }
            commonFunctionKotlin.scrolltoElement(androidDriver, basePageObject.relatedtopics)
            commonFunctionKotlin.elementDisplayed(androidDriver, basePageObject.relatedstories)
